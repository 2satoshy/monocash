# Crypto Maze Board — DeFi Agent Simulation
...
A Three.js WebGPU simulation of the **Crypto Maze Board**, a decentralized environment where 2000 autonomous DeFi agents trade, coordinate, and compete. Agents are divided into four teams: **Bulls, Bears, Whales, and Degens**. The world is a 3D maze board with interactive tiles (Assets, DeFi Protocols, Rank Up stations). Physics run on the GPU; state logic and crypto-economics run on the CPU.
